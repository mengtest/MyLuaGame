...
local MgLayerMultiTouch = require("MgLayerMultiTouch")
local MgLayerMap = require("MgLayerMap")

local MgLayerMapTouch = class("MgLayerMapTouch", MgLayerMultiTouch)


function MgLayerMapTouch:ctor()
    self.super.ctor(self)
    self.touchArray = MgUtils.AutoArray
    self:init()
end


function MgLayerMapTouch:init()
    -- self.super.init()
end


function MgLayerMapTouch:onTouchesBegan(touches, event)
...
function MgLayerMapTouch:distOfTwoPoint(pt1, pt2)
...
function MgLayerMapTouch:onTouchesMoved(touches, event)
    ...
    local mapLayer = MgLayerMap.getInstance()
    if deltaToMove then
...
function MgLayerMapTouch:onTouchesEnded(touches, event)
...
function MgLayerMapTouch:checkScale()
...
function MgLayerMapTouch:checkLocation()
    
end


function MgLayerMapTouch:onTouchBegan(touch, event)
    return true
end


function MgLayerMapTouch:onTouchMoved(touch, event)
    
end


function MgLayerMapTouch:onTouchEnded(touch, event)

end


return MgLayerMapTouch
