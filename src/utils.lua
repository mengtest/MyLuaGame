...
local function placeAlign(nodeWithSize, type, parent, xoff, yoff)
...
local function createButton(param)
    ...
    Util.placeAlign(titleLabel, "mm", btn)
...
local function createToggleButton(param)
    ...
    if text1 and text2 then
        ...
        Util.placeAlign(textLabel1, "mm", switchitem1)
        Util.placeAlign(textLabel2, "mm", switchitem2)
    end
...
local function createLabel(text, fontSize, font) 
...
Util = {}
Util.dump = dump
Util.AutoArray = AutoArray
Util.rerequire = rerequire
Util.placeAlign = placeAlign
Util.createButton = createButton
Util.createToggleButton = createToggleButton

Util.createLabel = createLabel
